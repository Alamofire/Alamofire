- [Advanced Usage](#advanced-usage)
  * [Session Manager](#session-manager)
    + [Creating a Session Manager with Default Configuration](#creating-a-session-manager-with-default-configuration)
    + [Creating a Session Manager with Background Configuration](#creating-a-session-manager-with-background-configuration)
    + [Creating a Session Manager with Ephemeral Configuration](#creating-a-session-manager-with-ephemeral-configuration)
