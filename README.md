...
3. In Xcode, navigate to the target configuration window of your own project by clicking on the blue project icon, and selecting the application target under the "Targets" heading in the sidebar.
